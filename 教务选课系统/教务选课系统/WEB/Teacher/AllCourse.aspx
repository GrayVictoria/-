            ...
            <div>
                ...
                <asp:GridView ID="课程表" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="cnum" DataNavigateUrlFormatString="~/WEB/Teacher/CourseDetail.aspx?cnum={0}" HeaderText="详情" Text="详情" />
                        <asp:HyperLinkField DataNavigateUrlFields="cnum" DataNavigateUrlFormatString="~/WEB/Teacher/StudentSheet.aspx?cnum={0}" HeaderText="选课名单" Text="选课名单" />
                    </Columns>
                </asp:GridView>
